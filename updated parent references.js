...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function highlightText(node, searchText) {
        if (node.nodeType === 3) { // Text node
            ...
            if (matchIndex !== -1) {
                ...
                const clone = matchedText.cloneNode(true);
    ...
    // Zoom-Compatible Smooth Scrolling
    document.querySelectorAll('.nav-tabs a').forEach(link => {
        link.addEventListener('click', function (event) {
            ...
            if (targetElement) {
                ...
                // Adjust scrolling for different zoom levels
                const adjustedScroll = scrollPosition - headerHeight - 10; // Extra margin for visibility
